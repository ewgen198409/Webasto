void burn_fan() {
  ...
  // Функция mapf масштабирует значение fan_speed от 0 до 100 в диапазон от 0 до 179.
  ...
  int max_pwm = 768;                                         // 75% от максимального значения ШИМ (1024)
  //            255 если 328PB !!!!!!!!!!!!!!!!!!!!
  int percent_map = mapf(fan_speed, 0, 100, 0, max_pwm);
